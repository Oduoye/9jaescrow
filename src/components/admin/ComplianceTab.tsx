...
type Props = {
  complianceViewUser: UserProfile | null;
  setComplianceViewUser: (u: UserProfile | null) => void;
  reactivationSearchEmail: string;
  setReactivationSearchEmail: (v: string) => void;
  isReactivating: boolean;
  handleReactivatePendingUser: (uid: string, email: string) => void;
};

export default function ComplianceTab({
  complianceViewUser,
  setComplianceViewUser,
  reactivationSearchEmail,
  setReactivationSearchEmail,
  isReactivating,
  handleReactivatePendingUser
}: Props) {
  return (

...
type Props = {
  traders: UserProfile[];
  selectedTrader: UserProfile | null;
  setSelectedTrader: (u: UserProfile | null) => void;
  traderActionReason: string;
  setTraderActionReason: (v: string) => void;
  isActioningTrader: boolean;
  handleSuspendUser: (uid: string, email: string) => void;
  handleTerminateUser: (uid: string, email: string) => void;
  handleReinstateUser: (uid: string, email: string) => void;
};

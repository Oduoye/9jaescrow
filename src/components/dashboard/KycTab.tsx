...
type Props = {
  ...
  setSelectedKycUser: (u: UserProfile | null) => void;
};

export default function KycTab({ kycUsers, setSelectedKycUser }: Props) {
  if (!kycUsers || kycUsers.length === 0) {
    return <p className="text-sm text-slate-400 py-12 text-center">No KYC submissions pending review.</p>;
  }
